...
const WRITABLE_SCALAR_FIELDS = ["userId", "title", "message", "type", "readStatus", "createdAt"] as const
...
export function createNotificationRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Notification not found" } }, 404)
      }
