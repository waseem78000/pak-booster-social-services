...
const WRITABLE_SCALAR_FIELDS = ["userId", "serviceId", "link", "quantity", "amount", "status", "approvedBy", "startCount", "completedAt", "createdAt"] as const
const RELATION_FIELDS = ["user", "service", "walletTransactions"] as const
