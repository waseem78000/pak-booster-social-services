...
/**
 * Hooks for PaymentSettings routes
 */
export interface PaymentSettingsHooks {
  /**
...
/**
 * Default PaymentSettings hooks (customize as needed)
 */
export const paymentSettingsHooks: PaymentSettingsHooks = {
