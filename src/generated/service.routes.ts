...
const WRITABLE_SCALAR_FIELDS = ["name", "category", "description", "price", "minQuantity", "maxQuantity", "avgStartTime", "speed", "status", "createdAt"] as const
...
export function createServiceRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Service not found" } }, 404)
      }
