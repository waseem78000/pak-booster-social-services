...
/**
 * Hooks for SiteSettings routes
 */
export interface SiteSettingsHooks {
  /**
...
/**
 * Default SiteSettings hooks (customize as needed)
 */
export const siteSettingsHooks: SiteSettingsHooks = {
