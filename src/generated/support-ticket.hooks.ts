...
/**
 * Hooks for SupportTicket routes
 */
export interface SupportTicketHooks {
  /**
...
/**
 * Default SupportTicket hooks (customize as needed)
 */
export const supportTicketHooks: SupportTicketHooks = {
