...
/**
 * Auto-generated SupportTicket Routes
 *
...
import type { SupportTicketHooks } from "./support-ticket.hooks"
...
/**
 * Set hooks for SupportTicket routes
 */
export function setSupportTicketHooks(h: SupportTicketHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "subject", "message", "status", "reply", "createdAt", "updatedAt"] as const
...
/**
 * Create SupportTicket CRUD routes
 */
export function createSupportTicketRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[SupportTicket] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "SupportTicket not found" } }, 404)
      }
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      console.error("[SupportTicket] Update error:", error)
