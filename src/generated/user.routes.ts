...
const WRITABLE_SCALAR_FIELDS = ["email", "username", "name", "passwordHash", "walletBalance", "status", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["deposits", "orders", "notifications", "supportTickets", "walletTransactions", "userPlans"] as const
