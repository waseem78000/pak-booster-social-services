...
/**
 * Hooks for WalletTransaction routes
 */
export interface WalletTransactionHooks {
  /**
...
/**
 * Default WalletTransaction hooks (customize as needed)
 */
export const walletTransactionHooks: WalletTransactionHooks = {
